...
$string['modulename'] = 'Trabalho Turnitin';
...
$string['turnitinapiurl_desc'] = '<b>[Obrigatório]</b><br />Digite a URL da API Turnitin<br /><i>(ex. https://api.turnitin.com/api.asp)<br />(ex. https://api.turnitinuk.com/api.asp)</i>';
...
$string['pseudolastnamegen_desc'] = 'Se definido como sim e o pseudo sobrenome for definido como campo do perfil do usuário então o campo será automaticamente preenchido com um identificador único.';
