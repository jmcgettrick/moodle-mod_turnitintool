...
$string['maxfilesize_help'] = 'Diese Voreinstellung legt die maximale Dateigröße für Übermittlungen zu Aufgabenteilen fest. Den maximalen Wert bestimmt der Wert in den Kursvoreinstellungen. Er ist auf eine maximale Dateigröße von 40Mb begrenzt. Dies ist die maximale Dateigröße für Dateiuploads bei Turnitin.';
...
$string['modulename'] = 'Turnitin-Aufgabe';
...
$string['turnitinapiurl_desc'] = '<b>[Erforderlich]</b><br />Geben Sie die API URL für Turnitin ein<br /><i>(z. B. https://api.turnitin.com/api.asp)<br />(z. B. https://api.turnitinuk.com/api.asp)</i>';
...
$string['pseudolastnamegen'] = 'Automatisch Nachnamen erstellen';
$string['pseudolastnamegen_desc'] = 'Wenn dies auf &#34;Ja&#34; gesetzt sowie der Pseudo-Nachname für ein Benutzerfeld eingestellt ist, wird das Feld automatisch mit einer eindeutigen Identifikationskennung gefüllt.';
...
$string['submitpapersto_help'] = '<strong>Keine Ablage: </strong><br />In Turnitin ist festgelegt, dass übermittelte Dokumente nicht in einem Repository gespeichert werden. Die Arbeiten werden lediglich verarbeitet, um die eigentliche Ähnlichkeitsprüfung durchzuführen.<br /><br /><strong>Standardablage: </strong><br />Turnitin speichert eine Kopie des übermittelten Dokuments nur im Standard-Repository. Bei Auswahl dieser Option verwendet Turnitin nur gespeicherte Dokumente, um Ähnlichkeitsprüfungen mit zukünftig übermittelten Dokumenten durchzuführen.<br /><br /><strong>Institutionsablage (wenn vorhanden): </strong><br />Mit dieser Option wird festgelegt, dass Turnitin übermittelte Dokumente nur zum privaten Repository Ihres Instituts hinzufügt. Ähnlichkeitsprüfungen übermittelter Dokumente werden von anderen Lehrkräften Ihrer Institution durchgeführt.';
$string['spapercheck_help'] = 'Mit dieser Option wird festgelegt, dass Turnitin übermittelte Dokumente nur zum privaten Repository Ihres Instituts hinzufügt. Ähnlichkeitsprüfungen übermittelter Dokumente werden von anderen Lehrkräften Ihrer Institution durchgeführt.';
