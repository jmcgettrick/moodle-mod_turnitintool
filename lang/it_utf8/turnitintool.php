...
$string['modulename'] = 'Compiti Turnitin';
...
$string['turnitinapiurl_desc'] = '<b> [Obbligatorio] </ b> <br /> Inserisci l&#39;URL dell&#39;API di Turnitin <br /> <i> (ad esempio https://api.turnitin.com/api.asp) <br /> (ad esempio, https: / / api.turnitinuk.com / api.asp) </ i>';
...
$string['submitpapersto_help'] = '<strong>Nessun repository: </strong><br />Turnitin è istruito di non archiviare in alcun archivio i documenti inviati. Elaboreremo gli elaborati solo per eseguire il controllo di somiglianza iniziale.<br /><br /><strong>Repository standard: </strong><br />Turnitin archivierà una copia del documento inviato solo nell\'archivio standard. Scegliendo questa opzione, Turnitin è istruito di utilizzare solo i documenti archiviati per eseguire controlli di somiglianza rispetto ai documenti inviati in futuro.<br /><br /><strong>Reposity dell&#39;istituzione (quando esiste): </strong><br />La scelta di questa opzione istruisce Turnitin di aggiungere solo i documenti inviati a un archivio privato del proprio istituto. I controlli di somiglianza con documenti inviati saranno eseguiti solo da altri docenti all\'interno del vostro istituto.';
$string['spapercheck_help'] = 'La scelta di questa opzione istruisce Turnitin di aggiungere solo i documenti inviati a un archivio privato del proprio istituto. I controlli di somiglianza con documenti inviati saranno eseguiti solo da altri docenti all\'interno del vostro istituto.';
