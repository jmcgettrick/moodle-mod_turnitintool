...
$string['maxfilesize_help'] = 'Ce paramètre définit la taille maximale des documents transmis par l’utilisateur pour chaque section. Cette taille maximale est déterminée dans les paramètres de cours. Cependant, cette valeur ne peut pas dépasser 40Mo, soit la taille maximale de téléchargement dans Turnitin.';
...
$string['modulename'] = 'Exercice Turnitin';
...
$string['turnitinapiurl_desc'] = '<b>[Demandé]</b><br />Entrer l’ URL de l’API de Turnitin<br /><i>(par exemple https://api.turnitin.com/api.asp)<br />(par exemple https://api.turnitinuk.com/api.asp)</i>';
...
$string['pseudolastnamegen_desc'] = 'Si cela a été activé (oui) et que le pseudo nom de famille est assigné à un champ du profil utilisateur, l´unique identifiant remplira automatiquement le champ.';
